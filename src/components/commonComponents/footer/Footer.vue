<script setup></script>
<template>
  <div class="bg-[url('./src/assets/images/footer.png')] md:bg-contain  bg-cover md:grid grid-cols-3 md:pt-24 pt-10 text-center  md:text-white text-black">
    <div class="md:mx-10">
      <p class="md:text-end mt-5 md:mt-0">
        © 2024 Insitute for Human Resource Professionals Limited. View out Terms
        of Use and Privacy Policy
      </p>
    </div>
    <div class="md:text-end mt-5 md:mt-0">
      <p>Find out about IHRP Certification at www.ihrp.s</p>
    </div>
    <div>
      <div>
        <div>
          <img src="" alt="" />
                ...
                <div class="flex items-center justify-center gap-x-5  mt-5 md:mt-0 pb-20 md:pb-0 ">
        <a href="" aria-label="Find us on LinkedIn"
            target="_blank" rel="noopener">
            <svg class="md:h-10 md:w-10 h-7 w-7  md:text-white text-blue-600" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="" aria-label="Find us on Twitter" target="_blank" rel="noopener">
            <svg class="md:h-10 md:w-10 h-7 w-7  md:text-white text-blue-600" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="" aria-label="Find us on Instagram" target="_blank"
            rel="noopener">
            <svg class="md:h-10 md:w-10 h-7 w-7  md:text-white text-red-600" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
