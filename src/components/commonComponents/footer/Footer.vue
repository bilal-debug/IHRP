...
<template>
  ...
  >
    ...
    <div>
      <div>
        <div
          class="flex items-center justify-center gap-x-5 mt-5 md:mt-0 pb-20 md:pb-0"
        >
          <a
            href=""
          ...
          >
            <svg
              class="md:h-10 md:w-10 h-7 w-7 md:text-white text-blue-600"
              viewBox="0 0 48 48"
              fill="none"
          ...
          >
            <svg
              class="md:h-10 md:w-10 h-7 w-7 md:text-white text-red-600"
              viewBox="0 0 48 48"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
